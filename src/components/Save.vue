  ...
  <div id="home" :style="{ background: myColor }">
    ...
    <div class="box">
      ...
      <div class="quote--left">
        ...
        >
          <path
            d="M0 49.489C0 39.4459 1.81501 33.5169 7.74401 23.8974C13.8545 14.0964 25.8335 4.47694 34.5455 -6.10352e-05L37.3285 5.38445C29.8265 10.7084 24.9865 14.8829 19.6625 25.1074C18.15 28.0115 17.303 30.5524 16.819 32.8514C17.9685 32.6095 19.239 32.4884 20.5095 32.4884C31.5205 32.4884 40.414 41.4424 40.414 52.4535C40.414 63.4645 31.5205 72.4185 20.5095 72.4185C11.374 72.4185 3.63001 66.2475 1.33101 57.7775C0.484009 55.3575 0 52.635 0 49.489Z"
            fill="white"
          />
          <path
            d="M51.9697 49.489C51.9697 39.4459 53.7847 33.5169 59.7137 23.8974C65.8242 14.0964 77.8032 4.47694 86.5152 -6.10352e-05L89.2982 5.38445C81.7962 10.7084 76.9562 14.8829 71.6322 25.1074C70.1197 28.0115 69.2727 30.5524 68.7887 32.8514C69.9382 32.6095 71.2087 32.4884 72.4792 32.4884C83.4902 32.4884 92.3837 41.4424 92.3837 52.4535C92.3837 63.4645 83.4902 72.4185 72.4792 72.4185C63.3437 72.4185 55.5997 66.2475 53.3007 57.7775C52.4537 55.3575 51.9697 52.635 51.9697 49.489Z"
            fill="white"
          />
        </svg>
      </div>
    ...
    <div class="count" v-if="showDiv">
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        class="heart"
        :class="{ active: newLike }"
        @click="show"
      >
        <path
          d="M18.4994 32.4584C-12.3333 15.4166 9.24998 -3.08336 18.4994 8.61489C27.75 -3.08336 49.3333 15.4166 18.4994 32.4584Z"
          stroke-opacity="0.92"
          stroke-width="1.8"
        />
      </svg>
    ...
    <div
      @click="randomQuotes"
      class="button--rotate"
      :style="{ transform: 'rotate(' + this.dataSpin + 'deg)' }"
    >
